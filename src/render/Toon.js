...
// ★ 처음에 0.38로 잡았다가 0.18로 내렸다. 0.38은 그림자 면을 38%나 들어 올려서
//   형태를 만드는 명암 대비를 통째로 죽였다 — 화면이 뿌옇게 평평해졌다(실사용 확인).
//   "그림자가 검지 않게"와 "그림자가 있게"는 둘 다 필요하다. 0.18이 그 경계다.
const SHADOW_FLOOR = 0.18;
